...
function Index() {
  ...
  const toggleTab = (itemId) => {
    ...
    if (itemId == "overview") {
      ...
      const redirectUrl =
        regionWiseUrl +
        "/continentcountries?destinationcode=" +
        destinationcode;
      window.history.pushState(null, null, redirectUrl);
      text = `COUNTRIES IN ${destinationName}`; // action="/countryregions?countrycode=south-africa"
      ...
      const redirectUrl =
        ...
        destinationcode;
      window.history.pushState(null, null, redirectUrl);
      text = `TAILOR-MADE ${destinationName} HOLIDAY ITINERARIES`; // action="/countryitineraries?countrycode=south-africa"
      ...
      const redirectUrl =
        ...
        destinationcode;
      window.history.pushState(null, null, redirectUrl);
      text = `PLACES TO STAY IN ${destinationName}`; // action="/countryplacetostay?countrycode=south-africa"
    } else {
      ...
      <section className="destination_tab_row light_grey pb-0">
        <div className="container-md">
          <div className="bookmark_row">
            <p style={{ color: `white` }}>
              {destinationDetails?.attributes?.page_friendly_url}
            </p>
            {/* <ul>
          ...
          <div className="destination_tab_inr">
            ...
            >
              <li className="nav-item" role="presentation">
                <button
                  className={
                    activeTab === "overview" ? "active nav-link" : "nav-link"
                  }
              ...
              <li className="nav-item" role="presentation">
                <button
                  className={
                    activeTab === "countries" ? "active nav-link" : "nav-link"
                  }
              ...
              <li className="nav-item" role="presentation">
                <button
                  className={
                    activeTab === "itineraries" ? "active nav-link" : "nav-link"
                  }
