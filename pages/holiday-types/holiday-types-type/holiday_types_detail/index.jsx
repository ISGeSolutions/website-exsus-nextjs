    ...
    return (
        <Layout>
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <a href="#" target="_blank" class="carousel-item active" data-bs-interval="5000">
                            <div class="banner_commn_cls holiday_types_detls_banner02"></div>
                        </a>
                    </div>
                </div>
            </section>

            <section class="destination_tab_row light_grey pb-0">
                <div class="container">
                    ...
                    <div class="destination_tab_inr">
                        <h2 class="tab_tilte">ULTIMATE JOURNEYS & INSPIRATION</h2>
            ...
            <section class="favrites_blk_row favrites_blk_no_slider_row light_dark_grey">
                <div class="container">
                    <h3 class="title_cls">TOP DESTINATIONS FOR ULTIMATE JOURNEYS</h3>
                    <div class="card_slider_row">
                        <div class="carousel00 region_carousel00">
                            <div class="row">
                                <div class="col-12">
                                    <div class="destination_dropdwn_row d-block d-md-flex">
                                        <div class="banner_dropdwn_blk">
                                            <div class="select_drpdwn">
                                                <select class="selectpicker" multiple aria-label="Filter by destination" data-live-search="true">
                                                    <option selected="">Filter by destination</option>
                                    ...
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types01.jpg" alt="holiday_types01" class="img-fluid" />
                                            </a>
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types02.jpg" alt="holiday_types02" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types03.jpg" alt="holiday_types03" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types04.jpg" alt="holiday_types04" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types05.jpg" alt="holiday_types05" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types06.jpg" alt="holiday_types06" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types07.jpg" alt="holiday_types07" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types08.jpg" alt="holiday_types08" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-sm-6 col-lg-4 col-xxl-3">
                                    <div class="card_slider_inr">
                                        <div class="card_slider">
                                            <a class="card_slider_img">
                                                <img src="images/holiday_types09.jpg" alt="holiday_types09" class="img-fluid" />
                                            </a>
                                            <div class="card_slider_cnt">
                                ...
                                <div class="col-12">
                                    <button class="btn prmry_btn make_enqury_btn mx-auto text-uppercase" fdprocessedid="r5vpm6s">Show 9 more holiday ideas
