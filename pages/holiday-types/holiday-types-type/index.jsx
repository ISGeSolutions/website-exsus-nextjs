...
function Index() {
    ...
    return (
        <Layout>
                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <a href="#" target="_blank" class="carousel-item active" data-bs-interval="5000">
                            <div class="banner_commn_cls holiday_types_detls_banner"></div>
                        </a>
                    </div>
                </div>
                <div class="banner_map_blk">
            ...
            <section class="destination_tab_row light_grey">
                <div class="container">
                    ...
                    <div class="destination_tab_inr">
                        <h2 class="tab_tilte">ONCE IN A LIFETIME HOLIDAYS</h2>
                        <div class="destinations_cntnt_blk destination_para pt-0">
                    ...
                    <section class="favrites_blk_row favrites_blk_small_card_row">
                        <div class="container">
                            <h3 class="title_cls">DISCOVER YOUR ONCE IN A LIFETIME HOLIDAY</h3>
                            <div class="row">
                                <div class="col-sm-6 col-md-4 col-lg-3">
                                    <div class="holiday_types_card">
                                        <a href="#">
                                            <div class="holiday_types_card_img">
                                                <img src="images/holiday_types_detls_card01.jpg" alt="holiday_types_detls_card01" class="img-fluid" />
                                            </div>
                                            <h4>
                                                Ultimate Journeys
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3">
                                    <div class="holiday_types_card">
                                        <a href="#">
                                            <div class="holiday_types_card_img">
                                                <img src="images/holiday_types_detls_card02.jpg" alt="holiday_types_detls_card02" class="img-fluid" />
                                            </div>
                                            <h4>
                                                Ultimate Adventures
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 267 512.43"><path fill-rule="nonzero" d="M3.22 18.9c-4.28-4.3-4.3-11.31-.04-15.64s11.2-4.35 15.48-.04l245.12 245.16c4.28 4.3 4.3 11.31.04 15.64L18.66 509.22a10.874 10.874 0 0 1-15.48-.05c-4.26-4.33-4.24-11.33.04-15.63L240.5 256.22 3.22 18.9z"></path></svg>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3">
                                    <div class="holiday_types_card">
                                        <a href="#">
                                            <div class="holiday_types_card_img">
                                                <img src="images/holiday_types_detls_card03.jpg" alt="holiday_types_detls_card03" class="img-fluid" />
                                            </div>
                                            <h4>See all
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 267 512.43"><path fill-rule="nonzero" d="M3.22 18.9c-4.28-4.3-4.3-11.31-.04-15.64s11.2-4.35 15.48-.04l245.12 245.16c4.28 4.3 4.3 11.31.04 15.64L18.66 509.22a10.874 10.874 0 0 1-15.48-.05c-4.26-4.33-4.24-11.33.04-15.63L240.5 256.22 3.22 18.9z"></path></svg>
                                            </h4>
            ...
            <section class="favrites_blk_row">
                <div class="container">
                    <h3 class="title_cls">ONCE IN A LIFETIME HOLIDAY IDEAS</h3>
                    <div class="card_slider_row">
                        ...
                        <div class="carousel00">
                            <div class="card_slider_inr">
                                <div class="card_slider">
                                    <a class="card_slider_img">
                                        <img src="images/holiday_types_slider01.jpg" alt="holiday_types_slider01" class="img-fluid" />
                                    </a>
                            ...
                            <div class="card_slider_inr">
                                <div class="card_slider">
                                    <div class="card_slider_img">
                                        <img src="images/holiday_types_slider02.jpg" alt="holiday_types_slider02" class="img-fluid" />
                                    </div>
                                    <div class="card_slider_cnt">
                                        <h4>Epic Iceland</h4>
                                        <ul>
                            ...
                            <div class="card_slider_inr">
                                <div class="card_slider">
                                    <div class="card_slider_img">
                                        <img src="images/holiday_types_slider03.jpg" alt="holiday_types_slider03" class="img-fluid" />
                                    </div>
                                    <div class="card_slider_cnt">
                            ...
                            <div class="card_slider_inr">
                                <div class="card_slider">
                                    <div class="card_slider_img">
                                        <img src="images/holiday_types_slider04.jpg" alt="holiday_types_slider04" class="img-fluid" />
                                    </div>
                                    <div class="card_slider_cnt">
                    ...
                    <div class="mt-5">
                        <button class="btn prmry_btn make_enqury_btn mx-auto text-uppercase">More itineraries in Once In A Lifetime Holidays<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 512 266.77"><path fill-rule="nonzero" d="M493.12 3.22c4.3-4.27 11.3-4.3 15.62-.04a10.85 10.85 0 0 1 .05 15.46L263.83 263.55c-4.3 4.28-11.3 4.3-15.63.05L3.21 18.64a10.85 10.85 0 0 1 .05-15.46c4.32-4.26 11.32-4.23 15.62.04L255.99 240.3 493.12 3.22z"></path></svg>
                        </button>
                    </div>
                </div>
                <div class="full_loader_parnt_blk loader_parnt_blk" style="display: none;"><div class="loader-circle-2"></div></div>
            </section>
