...
function Index() {
    ...
    return (
        <Layout>
            <section class="trvl_info_row privacy_policy_row">
                <div class="container-md">
                    ...
                    <div class="trvl_info_cntnt">
                        <h2 class="trvl_title">EXSUS TRAVEL’S PRIVACY POLICY</h2>
                        <h2 class="transfrm_none">Your privacy is important to us</h2>
                        <p class="mb-4 text-start">This Privacy Policy explains in detail the types of personal data we may collect about you when you interact with us. It also explains how we’ll store and handle that data, and keep it safe.</p>
                    ...
                    <div class="trvl_info_cntnt text-start">
                        <h2>1. Who We Are</h2>
                        <p class="mb-4">Exsus Travel Limited is a privately owned UK company specialising in luxury tailor-made holidays around the world.</p>
                        <p class="mb-4">Any personal information provided to or gathered by us is controlled by Exsus Travel Limited a company registered in England at 1 Burwood Place, London, W2 2UT. Company number: 03385363.</p>
                        <p class="mb-4">For simplicity throughout this notice, ‘we’ and ‘us’ means Exsus Travel Limited.</p>
                    </div>
                    <div class="trvl_info_cntnt text-start">
                        <h2>2. The legal basis of us collecting information</h2>
                        <p class="mb-4">The law on data protection sets out a number of different reasons for which a company may collect and process your personal data, including:</p>
                        <ul class="mb-4">
                            <li class="mb-4">- <b>Consent:</b> In specific situations, we can collect and process your data with your consent. For example, when you tick a box to receive email newsletters.</li>
                            <li class="mb-4">- <b>Contractual Obligations:</b> In certain circumstances, we need your personal data to comply with our contractual obligations. For example, if you book a tailor-made holiday through us, we’ll collect your passport details and use them to book your flights.</li>
                            <li class="mb-4">- <b>Legal Compliance:</b> If the law requires us to, we may need to collect and process your data. For example, we can pass on details of people involved in fraud or other criminal activity affecting Exsus Travel to law enforcements agencies.</li>
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <p class="mb-4">The information we collect about you will depend on how you interact with us and what services you arrange with us. Depending on the circumstances, we collect information in any of the following ways:</p>
                        <ul class="mb-4">
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <ul class="mb-4">
                            ...
                            <li class="mb-4">- <b>Identification documents:</b> If you are travelling on a route requiring Advance Passenger Information, your passport or identity card details including your passport number, the country in which your passport was issued and the expiry date.</li>
                            ...
                            <li class="mb-4">- <b>Your interactions with us:</b> Information about your interactions or conversations with us and our employees, including when you make enquiries, comments, complaints or submit feedback to us, via our website, email or verbally via our experts.</li>
                            <li class="mb-4">- <b>Your use of our systems and services:</b> Details of the way in which you use our website, app and social media pages (please see the “11. OUR SITE, APP AND COOKIES” section below for further details).</li>
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <p class="mb-4">We’ll use your information for a variety of different purposes, some of which will depend on the services that you engage us for. This includes:</p>
                        <ul class="mb-4">
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <p class="mb-4">You have the right to request the following:</p>
                        <ul class="mb-4">
                    ...
                    <div class="trvl_info_cntnt text-start">
                        <h2>10. Marketing</h2>
                        <p class="mb-4">We will keep you up to date with our latest news, offers, partnerships, promotions and competitions that we think might be of interest / relevant to you if you have indicated that you are happy to receive marketing communications from us – that is, if you have:</p>
                        <ul class="mb-4">
                        ...
                        <p class="mb-4">If you no longer want to hear from us, you can opt out or unsubscribe by:</p>
                        <ul class="mb-4">
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <p class="mb-4">This information will be collected by us or by a third party site analytics service provider, such as Google Analytics, and will be collected using cookies.</p>
                        <p class="mb-4">As we’ve described above, we use this information to save your settings, to help improve our functionality and services, run diagnostics, analyse trends, track visitor movements, gather broad demographic information and personalise our services.</p>
                    ...
                    <div class="trvl_info_cntnt text-start">
                        ...
                        <p class="mb-4">We hope this Privacy Policy has been helpful in setting out the way we handle your personal data and your rights to control it.</p>
                        <p class="mb-4">If you have any questions that haven’t been covered, please contact us below:</p>
                        <ul class="mb-4">
                            <li>- By email: <a href="#">escape@exsus.com</a></li>
                            <li>- By post: Communications Department, Exsus Travel, 1 Burwood Place, London, W2 2UT</li>
                        </ul>
                        <p class="mb-4">This policy is effective from 30th April 2018.</p>
                    </div>
                </div>
            </section>
