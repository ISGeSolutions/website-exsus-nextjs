                ...
                <div className="container">
                    ...
                    <div className="destination_tab_inr">
                        ...
                        <ul className="nav nav-pills justify-content-center" id="pills-tab" role="tablist">
                            ...
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="pills-region-tab" data-bs-toggle="pill" data-bs-target="#pills-region" type="button" role="tab" aria-controls="pills-region" aria-selected="true">Regions</button>
                            </li>
                            <li className="nav-item" role="presentation">
                            ...
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="pills-when-to-go-tab" data-bs-toggle="pill" data-bs-target="#pills-when-to-go" type="button" role="tab" aria-controls="pills-when-to-go" aria-selected="false">When to go</button>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div className="tab-pane fade show active" id="pills-overview" role="tabpanel" aria-labelledby="pills-overview-tab" tabIndex="0">
                        <div className="container">
                            <section className="destination_para">
                                ...
                                <p>From incredible architecture to natural gems, be transported to the classNameic Chinese landscapes of Guilin, with their karst mountains and winding rivers, immortalised by poets and writers over the centuries. Don't miss the chance to visit Avatar’s ‘Hallelujah Mountains’, inspired by Zhangjiajie National Forest Park in the heart of China, or head to the roof of the world – the Tibetan plateau.</p>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-sm-6 col-md-4 col-xxl-3">
                                        <div className="card_blk_inr flex-column">
                                            <a href="region_detail.html" target="_blank">
                                                    ...
                                                    <div className="banner_dropdwn_blk ps-0 ps-md-2">
                                                        <div className="select_drpdwn">
                                                            <select className="selectpicker" multiple aria-label="Filter by reason" data-live-search="true">
                                                                <option defaultValue>Filter by reason</option>
                                                ...
                                                <div className="card_slider_inr">
                                                    <div className="card_slider">
                                                        ...
                                                        <div className="card_slider_cnt">
                                                            ...
                                                            <ul>
                                                                <li>China in classNameic Style</li>
                                                                <li>China</li>
                                                ...
                                                <div className="card_slider_inr">
                                                    <div className="card_slider">
                                                        ...
                                                        <div className="card_slider_cnt">
                                                            ...
                                                            <ul>
                                                                <li>Southern China in classNameic Style</li>
                                                                <li>China</li>
