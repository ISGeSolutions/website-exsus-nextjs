...
function Index() {
    ...
    const validationSchema2 = Yup.object().shape({
        fullnameAndTitle: Yup.string()
            .required('Full and Title is required')
    });
                ...
                <div className="container">
                    ...
                    <form className="newslettr_form d-block d-sm-flex" onSubmit={handleSubmit2(onSignup)}>
                        <div className="newlettr_inpt">
                            <input type="text" placeholder="Full name and title" name="fullnameAndTitle" {...register2('fullnameAndTitle')} />
                            <div className="invalid-feedback mb-1">{errors2.fullnameAndTitle?.message}</div>
                        </div>
