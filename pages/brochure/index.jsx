...
function Index() {
    ...
    return (
        <Layout>
            <header class="brochure_header_row">
                ...
                <div class="container-md">
                    <form>
                        ...
                        <div class="row pt-4">
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="number" class="form-control" aria-label="ABTA number *" placeholder="ABTA number *" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="text" class="form-control" aria-label="Travel agent name *" placeholder="Travel agent name *" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="select_drpdwn validatn_cls">
                                    <select class="form-select" aria-label="How many brochures would you like?">
                        ...
                        <div class="row pt-4">
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="text" class="form-control" aria-label="Address line 1" placeholder="Address line 1" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="text" class="form-control" aria-label="Address line 2" placeholder="Address line 2" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="text" class="form-control" aria-label="State/Prov/Region" placeholder="State/Prov/Region" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="form-input">
                                    <input type="text" class="form-control" aria-label="Postal/Zip" placeholder="Postal/Zip" />
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-4">
                                <div class="select_drpdwn validatn_cls">
                    ...
                    <div class="contact_form_cntnt">
                        <div class="row">
                            <div class="col-12">
                                <div class="contact_form_cntnt_left">
                                    ...
                                    <div class="form-check mb-3">
                                        ...
                                        <label class="form-check-label" for="exampleCheck1">YES, I'd like to receive the latest news, offers and brochure by email.</label>
                                    </div>
                            ...
                            <div class="col-12">
                                <div class="row align-items-center mb-3">
                                    <div class="col-sm-2 col-md-1 text-center mb-3 mb-sm-0">
                                        <img src="images/mailchimp-gdpr.svg" alt="mailchimp-gdpr" />
                                    </div>
                                    <div class="col-sm-10 col-md-11">
                                        <div class="contact_form_cntnt_left">
                                            <p class="mb-0">We use Mailchimp as our marketing platform. By clicking below to subscribe, you acknowledge that your information will be transferred to Mailchimp for processing. <a href="https://mailchimp.com/legal/terms/">Learn more about Mailchimp's privacy practices here.</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <button class="btn prmry_btn make_enqury_btn mx-auto text-uppercase">Request Brochures<svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 267 512.43"><path fill-rule="nonzero" d="M3.22 18.9c-4.28-4.3-4.3-11.31-.04-15.64s11.2-4.35 15.48-.04l245.12 245.16c4.28 4.3 4.3 11.31.04 15.64L18.66 509.22a10.874 10.874 0 0 1-15.48-.05c-4.26-4.33-4.24-11.33.04-15.63L240.5 256.22 3.22 18.9z" /></svg>
                                </button>
                            </div>
            ...
            <section class="brochure_testimonial_row">
                <div class="container-md">
            ...
            <footer class="brochure_footer_row">
                <p>
