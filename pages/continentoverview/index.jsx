              ...
              <div className="carousel00">
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img01.jpg"
                        alt="small_card_img01"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img02.jpg"
                        alt="small_card_img02"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img03.jpg"
                        alt="small_card_img03"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img04.jpg"
                        alt="small_card_img04"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img05.jpg"
                        alt="small_card_img05"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img06.jpg"
                        alt="small_card_img06"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img07.jpg"
                        alt="small_card_img07"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img08.jpg"
                        alt="small_card_img08"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
                ...
                <div className="card_slider_inr card_slider_inr_sml">
                  <a href="#">
                    <div className="card_slider_inr_sml_img">
                      <img
                        src="./../../images/small_card_img09.jpg"
                        alt="small_card_img09"
                        className="img-fluid"
                      />
                    </div>
                    <h4>
