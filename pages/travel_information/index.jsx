        ...
        <div className="container">
          ...
          <div className="trvl_info_cntnt">
            ...
            <p>
              ...
              links below provide pre-trip advice and practical information for
              all your holiday essentials. Please advise your travel expert of
              any special requirements at the outset of the booking process.
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>TRAVEL ADVICE</h2>
            <p>
              ...
              <a href="#">www.gov.uk/foreign-travel-advice</a>
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>ABTA PROTECTION</h2>
            <p className="mb-4">
              Exsus Travel Ltd is a Member of ABTA with membership number Y6561.
              ...
              go to <a href="#">www.abta.com</a> to use ABTA’s simple procedure.
              Further information on the Code and ABTA’s assistance in resolving
              disputes can be found on <a href="#">www.abta.com.</a>
            </p>
            <p>
          ...
          <div className="trvl_info_cntnt">
            ...
            <p>
              ...
              financially protected by the ATOL scheme. Please ask us to confirm
              ...
              to: <a href="#">www.caa.co.uk.</a> Our ATOL number is 5126.
            </p>
          </div>
          <div className="trvl_info_cntnt">
            ...
            <p className="mb-4">
              ...
              Association. AITO encourages the highest standards in all aspects
              of tour operating and customer service. Exsus Travel abides by the
              Association’s Code of Conduct and Quality Charter.
            </p>
            <p>
              Visit <a href="#">www.aito.com</a> for more information
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>PASSPORT & VISAS</h2>
            <p>
              Please ensure all passports have a minimum of 6 months validity on
              your return date of travel, visas may be required, and it is your
              ...
              visiting: <a href="#">www.cibtvisas.co.uk/exsus.</a>
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>TRAVEL TO USA</h2>
            <p>
              Those seeking to travel to the United States under the Visa Waiver
              ...
              following process: <a href="#">https://esta.cbp.dhs.gov</a>
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>HEALTH</h2>
            <p>
              Please ensure you have the correct vaccinations before travelling
              ...
              <a href="#">www.fitfortravel.nhs.uk</a>
            </p>
          </div>
          <div className="trvl_info_cntnt">
            <h2>TRAVEL INSURANCE</h2>
            <p>
              Please take the time to ensure you have adequate travel insurance
              for your trip when you book your holiday so that you have cover in
              the event of cancellation, such as due to an illness or a serious
              accident. Cover should also include medical expenses and
              repatriation in the event of accident or illness. We also
              recommend you have cover for personal belongings, travel delay,
              personal liability and overseas legal expenses. If you intend to
              take part in any adventurous activities or sports on your trip,
              including trekking, you should ensure you have sufficient cover
              for these also.
            </p>
          </div>
        </div>
