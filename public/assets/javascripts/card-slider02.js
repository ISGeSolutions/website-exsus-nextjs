setTimeout(() => {
    ...
    let autoSlide1 = () => {
        ...
        if (carousel01.scrollLeft > prevScrollLeft1) {
            return carousel01.scrollLeft += positionDiff1 > firstImgWidth / 3 ? valDifference : -positionDiff1;
        }

        carousel01.scrollLeft -= positionDiff1 > firstImgWidth / 3 ? valDifference : -positionDiff1;
    }
