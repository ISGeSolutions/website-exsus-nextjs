                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="95%" align="center" style=" padding:0 0 20px;">
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" height="25px" style="padding: 15px 5px;">
                                                    <font face="Verdana" color="#5d5d5d" size="2">The following request was recieved at <a href="http://www.exsus.com" style="text-decoration:none; color:#8aad56; font-weight:bold;">exsus.com</a> @CreatedDate</font>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Title: </strong> @Title</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Best Time To Contact: </strong> @BestTimeToContact</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Preferred Destinations: </strong> @PreferredDestination</font>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>How did you hear about us: </strong> @KnowAboutUs</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Would like to receive information on holiday offers: </strong> @ReceiveOffer</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>I was just looking at: </strong> @PageHeader</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Ad: </strong> @Ad</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Adgroup: </strong> @Adgroup</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Source: </strong> @Source</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Medium: </strong> @Medium</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Campaign: </strong> @Campaign</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Content: </strong> @Content</font>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                            ...
                                            <tr>
                                                <td bgcolor="#fff" width="580" height="20px" style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;">
                                                    <font face="Verdana" color="#5d5d5d" size="2"><strong>Receive offers: </strong> @ReceiveOffer</font>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
