...
export function SubscriptionConsultantEmail(props) {
                      ...
                      >
                        <tr>
                          <td
                            bgcolor="#fff"
                            height="20px"
                            style="padding: 15px 5px 0; font-weight:bold; text-transform:uppercase;"
                          >
                        ...
                        <tr>
                          ...
                          >
                            <font face="Verdana" color="#5d5d5d" size="2">
                              ...
                              <a
                                href="#"
                                style="text-decoration:none; color:#8aad56; font-weight:bold;"
                              >
                                exsus.com
                              </a>{" "}
                              @CreatedDate
                        ...
                        <tr>
                          <td
                            bgcolor="#fff"
                            height="20px"
                            style="padding:10px 5px; border-bottom: 1px solid #f0f0f0;"
                          >
                            <font face="Verdana" color="#5d5d5d" size="2">
                        ...
                        <tr>
                          ...
                          >
                            <font face="Verdana" color="#5d5d5d" size="2">
                              <strong>Submitted at: </strong> @CreatedDate
                            </font>
                          </td>
                        </tr>
                        <tr>
                          ...
                          >
                            <font face="Verdana" color="#5d5d5d" size="2">
                              <strong>Submitted from: </strong> @SubmittedFrom{" "}
                            </font>
                          </td>
                        </tr>
                        <tr>
