        ...
        <>
            ...
            <form className="newslettr_form d-block d-sm-flex" onSubmit={handleSubmit(onSignup)}>
                ...
                <div className="newlettr_btn ps-0 ps-sm-2">
                    <button disabled={formState.isSubmitting} type="submit" className="btn btn-primary prmry_btn">{formState.isSubmitting && <span className="spinner-border spinner-border-sm mr-1"></span>}Sign up
